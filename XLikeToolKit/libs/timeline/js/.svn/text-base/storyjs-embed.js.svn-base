...
function createStoryJS(e, t) {
    ...
    function T() {
        ...
        h.embed_id != "" ? i = document.getElementById(h.embed_id) : i = document.getElementById(div);
        i.appendChild(r);
...
function drawTimelineChart(timelineOptions){
	if(timelineOptions.container.indexOf("#") == -1){
		div = "#" + timelineOptions.container;
	}
	
	if (typeof embed_path == "undefined" || typeof embed_path == "undefined") embed_path = getEmbedScriptPath("storyjs-embed.js").split("js/")[0]; (function() {
		typeof url_config == "object" ? createStoryJS(url_config) : typeof timelineOptions == "object" ? createStoryJS(timelineOptions) : typeof storyjs_config == "object" ? createStoryJS(storyjs_config) : typeof config == "object" && createStoryJS(config)
	})();
}